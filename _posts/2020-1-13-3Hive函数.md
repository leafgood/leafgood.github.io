...
# 2. 查看函数帮助
这么多函数也不能总是查手册，有没有便捷的方式，给我们提供一些使用帮助呢？当然有
显示函数帮助的方法
```
0: jdbc:hive2://hadoop10:10000> desc function abs;
+-------------------------------------------+
|                 tab_name                  |
+-------------------------------------------+
...
```
貌似太少了，有没有更详细的呢？那看下面的
详细显示函数的用法
```
0: jdbc:hive2://hadoop10:10000> desc function extended abs;
